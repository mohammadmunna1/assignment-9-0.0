...
const Header = () => {
  ...
  const handleClick = () => {
    ...
    return (
      ...
      <div>
        <h1 className="text-4xl font-bold mt-4 text-lime-400">Just One Step <br /> To Your <br />
        <span className=' text-blue-700'> Future Job</span></h1>
        <p className='mt-4 text-gray-900'>Explore thousands of job opportunities with all the <br /> information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
      ...
      <div>
        <p className=' font-semibold text-4xl text-center mt-6 mb-2 text-lime-400'>Job List</p>
      ...
      <p className=' font-semibold text-4xl text-center mt-6 mb-2'>Featured Jobs</p>
        <p className='text-sm text-gray-300 text-center mb-12'>Explore thousands of job opportunities with all the information you need. Its your future</p>
